...
here, date = os.path.abspath('.'), datetime.today().strftime('%Y-%m-%d')
# input(f"Tape to save csv at {os.path.abspath('.')}\n")
df.to_csv(f"{here}/Stocks_Prices/brvm_last_prices_{date}_Snap_21H.csv")
# input(df)