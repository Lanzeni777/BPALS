...
class StockEvaluator:
    ...
    def hybrid_rank_stocks(self, ticker_list=None, weight=None, start_date="2015-01-01"):
        ...
        for stock in common_stocks:
            sval = simple_scores.loc[stock, "Score"]
            rel = rel_scores.loc[stock, "RelativeScore"]
            val = val_scores.loc[stock, "value_score"]
            final_score = sval*w_simple + w_relative * rel + w_value * val
    ...
    def do_picking_analysis(self, ticker_list=None, weight=None):
        weight = [1/3, 1/3, 1/3] if weight is None else weight
        return self.hybrid_rank_stocks(ticker_list, weight)
